...
return [
    ...
    'attention' => [
        'critical_projection_branches_title' => 'د پروجکشن بحراني څانګې',
        'critical_projection_branches_detail' => 'د :count څانګو پروجکشن بیاکتنې ته اړتیا لري.',
        'projection_warnings_title' => 'د پروجکشن خبرتیاوې',
        'projection_warnings_detail' => ':count څانګې زاړه یا خبرداري لرونکي پروجکشنونه لري.',
    ...
    'projection' => [
        'branch_current' => 'پروجکشن تازه دی.',
        'branch_missing' => 'د سرچینې وروستی فعالیت شته خو هېڅ پروجکشن نه دی ثبت شوی.',
        'branch_critical' => 'پروجکشن د وروستي سرچینې فعالیت څخه په بحراني ډول شاته دی.',
        'branch_warning' => 'پروجکشن د وروستي سرچینې فعالیت څخه شاته دی.',
        'branch_unavailable' => 'د دې څانګې لپاره لا تر اوسه د پروجکشن معلومات نه دي ثبت شوي.',
        'overall_critical' => 'یو یا څو څانګې د وروستي سرچینې فعالیت څخه په څرګند ډول شاته دي.',
        'overall_warning' => 'د ځینو څانګو لپاره د پروجکشن تازه کول ځنډېدلي دي.',
        'overall_unavailable' => 'د پروجکشن معلومات لا نه دي جوړ شوي.',
        'overall_healthy' => 'د فعالو څانګو لپاره د پروجکشن معلومات تازه دي.',
    ],
];
