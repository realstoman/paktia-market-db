const en = {
    ...
    properties: {
        ...
        modals: {
            ...
            toggle: {
                ...
                deactivateDescription: 'This will mark the property as inactive.',
            },
            delete: {
    ...
    reportPage: {
        ...
        chart: {
            ...
            propertyRevenueDescription: 'Top markets by available report value.',
            roleMix: 'Role mix',
    ...
    employees: {
        ...
        filters: {
            ...
            searchPlaceholder: 'Search employees by name, phone, or property...',
            searchProperties: 'Search properties...',
    ...
    financeDashboard: {
        ...
        charts: {
            ...
            propertyRevenueDescription: 'Compare financial activity by property.',
    ...
    propertyWorkspace: {
        ...
        registerHelp: 'Create the profile first. Floors and rentable spaces can be added afterward.',
        edit: 'Edit property',
        editTitle: 'Edit property details',
        editHelp: 'Update identity, translations, location and physical details.',
        ...
        relatedHelp: 'Choose the original property when registering another location in a different province or country.',
        ...
        basementHelp: 'Use a negative floor number for basements, for example -1.',
        addFloor: 'Add floor',
        addShop: 'Add shop',
        addApartment: 'Add apartment',
        noFloors: 'No floors yet. Add a basement, ground floor or upper floor to begin.',
        noSpaces: 'No :spaces have been added.',
        deleteFloor: 'Delete this floor and all of its spaces?',
        deleteSpace: 'Delete this space?',
        houseHelp: 'House details are managed at property level. The complete house can later be assigned to one rental contract.',
        fields: {
            name: 'Name', type: 'Property type', usage: 'Use', country: 'Country', province: 'Province',
            photo: 'Photo', address: 'Address', description: 'Description', distance: 'Distance from city (km)',
            landArea: 'Land area (m²)', buildingArea: 'Building area (m²)', floors: 'Number of floors',
            expectedShops: 'Expected shops', expectedApartments: 'Expected apartments', parking: 'Parking spaces',
            rooms: 'Rooms', kitchens: 'Kitchens', halls: 'Halls', bathrooms: 'Bathrooms', floorName: 'Floor name',
            levelNumber: 'Level number', area: 'Area (m²)', plannedSpaces: 'Planned spaces', width: 'Width (m)',
            length: 'Length (m)', electricityMeter: 'Electricity meter', waterMeter: 'Water meter',
            shopNumber: 'Shop number', apartmentNumber: 'Apartment number',
        },
        ...
        types: { market: 'Market', mall: 'Mall', block: 'Residential block', house: 'House' },
        usage: { commercial: 'Commercial', residential: 'Residential', mixed: 'Mixed use' },
        selectCountry: 'Select country',
        selectProvince: 'Select province',
        cancel: 'Cancel',
        save: 'Save changes',
        create: 'Register property',
        employees: 'Employees', employeesHelp: 'Assign staff and payroll to this property',
        expenses: 'Expenses', expensesHelp: 'Track maintenance and operating costs',
        shareholders: 'Shareholders', shareholdersHelp: 'Ownership and distribution workspace',
        rentContracts: 'Rent & contracts', rentContractsHelp: 'Tenants, contracts and payment collection',
