const en = {
    ...
    tenants: {
        title: 'Tenants & Businesses', subtitle: 'Register renters, assign shops and properties, and keep every contract and document together.',
        register: 'Register tenant', scan: 'Scan tenant card', scanPlaceholder: 'Scan a card or enter its code…', scanHelp: 'Scan a printed barcode to open the tenant profile instantly.',
        searchPlaceholder: 'Search by person, business, phone or card code…', empty: 'No tenants match your search.',
        active: 'Active', inactive: 'Inactive', individual: 'Individual', company: 'Company', identity: 'Identity & business', contact: 'Contact information',
        total: 'Registered tenants', assigned: 'Assigned spaces', businesses: 'Businesses', properties: 'Properties represented', viewProfile: 'View profile', editProfile: 'Edit profile', statusAction: 'Change status',
        fields: { tenantType: 'Renter type', fullName: 'Full name / responsible person', fatherName: "Father's name", businessName: 'Business / company name', phone: 'Phone', whatsapp: 'WhatsApp', email: 'Email', nid: 'NID number', license: 'Business license number', address: 'Address', photo: 'Photo', documents: 'NID, license and other documents', notes: 'Notes', select: 'Select an option' },
        lease: { title: 'Property assignment', optional: 'Optional during registration', add: 'Add assignment', property: 'Market or property', space: 'Shop, apartment or property', wholeProperty: 'Complete property', startDate: 'Start date', endDate: 'End date', rent: 'Rent amount', deposit: 'Security deposit', currency: 'Currency', frequency: 'Payment frequency', status: 'Contract status', terms: 'Contract terms', notes: 'Assignment notes', monthly: 'Monthly', quarterly: 'Quarterly', yearly: 'Yearly', draft: 'Draft', active: 'Active', ended: 'Ended', terminated: 'Terminated', shop: 'Shop', apartment: 'Apartment', house: 'House', block: 'Complete block', noAssignment: 'No property assignment has been created yet.', history: 'Contract & assignment history', contractNumber: 'Contract number', current: 'Current assignment', availableOnly: 'Only active spaces are listed.' },
        profile: { overview: 'Profile overview', documents: 'Private documents', upload: 'Upload documents', privateHelp: 'Identity and license files are stored privately.', finance: 'Rent & finances', financeHelp: 'The rent ledger, payments and balances will be connected in the next finance phase.', printCard: 'Print ID card', created: 'Registered', deactivate: 'Deactivate', activate: 'Activate' },
        card: { title: 'Market tenant card', responsible: 'Responsible person', location: 'Assigned location', code: 'Tenant code', print: 'Print card', back: 'Back to profile', scanHelp: 'Scan to open the tenant profile' },
    },
    dashboardPage: {
        title: 'Dashboard',
