const en = {
    ...
    activityLogsPage: {
        title: 'Activity Logs',
        subtitle: 'Logs are retained for 30 days. Older data is available in the monthly archives below.',
        refresh: 'Refresh',
        search: 'Search',
        ...
        pagination: 'Showing :start–:end of :total records · page :page of :pages',
        table: {
            when: 'When', user: 'User', action: 'Action', entity: 'Entity',
            property: 'Property', ip: 'IP', details: 'Details', view: 'View',
            empty: 'No activity was found with these filters.', system: 'System',
        },
        archives: {
            title: 'Archived periods',
            subtitle: 'Download archived logs for record-keeping. Each archive is a compressed monthly JSON-lines file.',
            empty: 'No archives yet. Archives are generated daily at 03:00 AM.',
            period: 'Period', records: 'Records', size: 'Size', created: 'Created', download: 'Download',
        },
        drawer: {
            batch: 'Batch', property: 'Property', additionalContext: 'Additional context',
        },
        show: {
            pageTitle: 'Activity Log #:id', back: 'Back to list', method: 'Method',
            changes: 'Changes', context: 'Context', userAgent: 'User agent',
        },
        diff: {
            empty: 'No field-level changes were recorded.', field: 'Field', before: 'Before', after: 'After',
        },
        actions: {
            created: 'Created', updated: 'Updated', deleted: 'Deleted', restored: 'Restored',
            login: 'Logged in', logout: 'Logged out', loginFailed: 'Failed login', lockout: 'Account locked',
            passwordReset: 'Password reset', registered: 'Registered', emailVerified: 'Email verified',
            twoFactorEnabled: '2FA enabled', twoFactorConfirmed: '2FA confirmed', twoFactorDisabled: '2FA disabled',
            twoFactorFailed: '2FA failed', recoveryCodesGenerated: 'Recovery codes generated',
        },
        entities: {
            InventoryItem: 'Inventory item', InventoryTransaction: 'Inventory transaction', Expense: 'Expense',
            CashMovement: 'Cash movement', Employee: 'Employee', EmployeeContract: 'Employee contract',
            EmployeeAdvance: 'Employee advance', PayrollRun: 'Payroll run', PayrollRunItem: 'Payroll item',
            Property: 'Property', User: 'User', SystemSetting: 'System setting', Tenant: 'Tenant',
            Lease: 'Lease', Shareholder: 'Shareholder', PropertyShareholding: 'Property shareholding',
        },
        fields: {
            id: 'ID', name: 'Name', full_name: 'Full name', email: 'Email', phone: 'Phone',
            address: 'Address', description: 'Description', status: 'Status', amount: 'Amount',
            is_active: 'Active', property_id: 'Property', user_id: 'User', created_at: 'Created at',
            updated_at: 'Updated at', deleted_at: 'Deleted at', business_name: 'Business name',
            nid_number: 'NID number', license_number: 'License number', percentage: 'Percentage',
        },
    },
    tenants: {
