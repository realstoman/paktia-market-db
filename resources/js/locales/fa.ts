const fa = {
    ...
    tenants: {
        title: 'مستأجران و کسبه‌کاران', subtitle: 'ثبت کرایه‌داران، واگذاری دوکان و ملک، و نگهداری قراردادها و اسناد در یک محل.',
        register: 'ثبت مستأجر', scan: 'اسکن کارت مستأجر', scanPlaceholder: 'کارت را اسکن یا کُد آن را وارد کنید…', scanHelp: 'با اسکن بارکُد چاپ‌شده، پروفایل مستأجر فوراً باز می‌شود.',
        searchPlaceholder: 'جستجو بر اساس نام، تجارت، تلفن یا کُد کارت…', empty: 'مستأجری مطابق جستجوی شما پیدا نشد.',
        active: 'فعال', inactive: 'غیرفعال', individual: 'شخص', company: 'شرکت', identity: 'هویت و تجارت', contact: 'معلومات تماس',
        total: 'مستأجران ثبت‌شده', assigned: 'محل‌های واگذارشده', businesses: 'تجارت‌ها', properties: 'املاک مربوط', viewProfile: 'مشاهده پروفایل', editProfile: 'ویرایش پروفایل', statusAction: 'تغییر وضعیت',
        fields: { tenantType: 'نوع مستأجر', fullName: 'نام کامل / شخص مسئول', fatherName: 'نام پدر', businessName: 'نام تجارت / شرکت', phone: 'شماره تماس', whatsapp: 'واتس‌اپ', email: 'ایمیل', nid: 'شماره تذکره', license: 'شماره جواز تجارت', address: 'آدرس', photo: 'عکس', documents: 'تذکره، جواز و اسناد دیگر', notes: 'یادداشت', select: 'انتخاب کنید' },
        lease: { title: 'واگذاری ملک', optional: 'هنگام ثبت اختیاری است', add: 'افزودن واگذاری', property: 'مارکیت یا ملک', space: 'دوکان، آپارتمان یا ملک', wholeProperty: 'تمام ملک', startDate: 'تاریخ شروع', endDate: 'تاریخ ختم', rent: 'مبلغ کرایه', deposit: 'تضمین', currency: 'واحد پول', frequency: 'دوره پرداخت', status: 'وضعیت قرارداد', terms: 'شرایط قرارداد', notes: 'یادداشت واگذاری', monthly: 'ماهانه', quarterly: 'سه‌ماهه', yearly: 'سالانه', draft: 'پیش‌نویس', active: 'فعال', ended: 'ختم‌شده', terminated: 'فسخ‌شده', shop: 'دوکان', apartment: 'آپارتمان', house: 'خانه', block: 'تمام بلاک', noAssignment: 'هنوز هیچ ملکی واگذار نشده است.', history: 'تاریخچه قرارداد و واگذاری', contractNumber: 'شماره قرارداد', current: 'واگذاری فعلی', availableOnly: 'تنها محل‌های فعال نمایش داده می‌شوند.' },
        profile: { overview: 'نمای کلی پروفایل', documents: 'اسناد خصوصی', upload: 'بارگذاری اسناد', privateHelp: 'فایل‌های هویتی و جواز به‌صورت خصوصی نگهداری می‌شوند.', finance: 'کرایه و امور مالی', financeHelp: 'دفتر کرایه، پرداخت‌ها و باقیات در مرحله بعدی مالی وصل می‌شود.', printCard: 'چاپ کارت شناسایی', created: 'تاریخ ثبت', deactivate: 'غیرفعال‌سازی', activate: 'فعال‌سازی' },
        card: { title: 'کارت مستأجر مارکیت', responsible: 'شخص مسئول', location: 'محل واگذارشده', code: 'کُد مستأجر', print: 'چاپ کارت', back: 'بازگشت به پروفایل', scanHelp: 'برای بازکردن پروفایل اسکن کنید' },
    },
    dashboardPage: {
        title: 'دشبورد',
