const fa = {
    ...
    branches: {
        ...
        feedback: {
            ...
            branchUpdated: 'شعبه با موفقیت آپدیت شد.',
    ...
    reportPage: {
        ...
        toolbar: {
            ...
            selectBranch: 'انتخاب مارکیت',
            allBranches: 'همه مارکیت‌ها',
            active: 'فعال',
            range: 'محدوده',
            period: 'دوره',
            branch: 'مارکیت',
        ...
        chart: {
            ...
            branchRevenue: 'پوشش مارکیت',
            branchRevenueDescription: 'مارکیت‌های برتر بر اساس ارزش گزارش.',
