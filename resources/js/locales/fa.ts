const fa = {
    ...
    auth: {
        login: {
            ...
            description:
                'مدیریت مارکیت ها، جایداد ها، جایدادها، گدام، امور مالی و عملیات روزانه.',
        ...
        securedBy: 'محافظت‌شده با رمزگذاری ستندرد صنعتی',
        promo: {
    ...
    activityLogsPage: {
        ...
        subtitle: 'گزارش‌ها برای ۳۰ روز نگهداری می‌شوند. اطلاعات قدیمی‌تر در آرشیف‌های ماهانه زیر موجود است.',
        refresh: 'تازه‌سازی',
        search: 'جستجو',
        ...
        pagination: 'نمایش :start تا :end از :total مورد · صفحه :page از :pages',
        table: {
            when: 'زمان', user: 'کاربر', action: 'فعالیت', entity: 'بخش مربوط',
            property: 'ملک', ip: 'آدرس IP', details: 'جزئیات', view: 'مشاهده',
            empty: 'هیچ فعالیتی مطابق این فیلترها پیدا نشد.', system: 'سیستم',
        },
        archives: {
            title: 'دوره‌های آرشیف‌شده',
            subtitle: 'گزارش‌های آرشیف‌شده را برای نگهداری سوابق دریافت کنید. هر آرشیف یک فایل فشرده ماهانه است.',
            empty: 'هنوز آرشیفی موجود نیست. آرشیف‌ها هر روز ساعت ۳ بامداد ساخته می‌شوند.',
            period: 'دوره', records: 'تعداد سوابق', size: 'حجم', created: 'تاریخ ایجاد', download: 'دریافت',
        },
        drawer: {
            batch: 'دسته', property: 'ملک', additionalContext: 'معلومات اضافی',
        },
        show: {
            pageTitle: 'گزارش فعالیت شماره :id', back: 'بازگشت به فهرست', method: 'روش',
            changes: 'تغییرات', context: 'جزئیات اضافی', userAgent: 'مشخصات مرورگر',
        },
        diff: {
            empty: 'هیچ تغییر جزئی در فیلدها ثبت نشده است.', field: 'فیلد', before: 'مقدار قبلی', after: 'مقدار جدید',
        },
        actions: {
            created: 'ایجاد شد', updated: 'ویرایش شد', deleted: 'حذف شد', restored: 'بازیابی شد',
            login: 'ورود به سیستم', logout: 'خروج از سیستم', loginFailed: 'ورود ناموفق', lockout: 'حساب قفل شد',
            passwordReset: 'رمز عبور بازنشانی شد', registered: 'ثبت‌نام شد', emailVerified: 'ایمیل تأیید شد',
            twoFactorEnabled: 'تأیید دومرحله‌ای فعال شد', twoFactorConfirmed: 'تأیید دومرحله‌ای تصدیق شد',
            twoFactorDisabled: 'تأیید دومرحله‌ای غیرفعال شد', twoFactorFailed: 'تأیید دومرحله‌ای ناموفق بود',
            recoveryCodesGenerated: 'کُدهای بازیابی ساخته شد',
        },
        entities: {
            InventoryItem: 'قلم موجودی', InventoryTransaction: 'تراکنش موجودی', Expense: 'مصرف',
            CashMovement: 'حرکت نقدی', Employee: 'کارمند', EmployeeContract: 'قرارداد کارمند',
            EmployeeAdvance: 'پیش‌پرداخت کارمند', PayrollRun: 'دوره معاشات', PayrollRunItem: 'قلم معاش',
            Property: 'ملک', User: 'کاربر', SystemSetting: 'تنظیم سیستم', Tenant: 'مستأجر',
            Lease: 'قرارداد کرایه', Shareholder: 'سهمدار', PropertyShareholding: 'سهم ملک',
        },
        fields: {
            id: 'شناسه', name: 'نام', full_name: 'نام کامل', email: 'ایمیل', phone: 'شماره تماس',
            address: 'آدرس', description: 'توضیحات', status: 'وضعیت', amount: 'مبلغ',
            is_active: 'فعال', property_id: 'ملک', user_id: 'کاربر', created_at: 'تاریخ ایجاد',
            updated_at: 'تاریخ ویرایش', deleted_at: 'تاریخ حذف', business_name: 'نام تجارت',
            nid_number: 'شماره تذکره', license_number: 'شماره جواز', percentage: 'درصد',
        },
    },
    tenants: {
    ...
    propertyDashboard: {
        ...
        eyebrow: 'گزارش‌دهی مجموعه',
        subtitle:
            'گزارش عمومی و جداگانه کرایه، اشغال دکان‌ها و مصارف هر پروژه.',
        newRecord: 'ثبت جدید',
        overall: 'آمار عمومی',
        totalProjects: 'مجموع پروژه‌ها',
        activeProjects: 'پروژه‌های فعال',
        inactiveProjects: 'پروژه‌های غیرفعال',
        totalFloors: 'مجموع منزل‌ها',
        totalShops: 'مجموع دکان‌ها',
        registeredTenants: 'کرایه‌نشینان ثبت‌شده',
        projectPerformance: 'عملکرد پروژه‌ها',
        projectPerformanceHelp: 'موجودی نقد و مصارف تاییدشده هر پروژه',
