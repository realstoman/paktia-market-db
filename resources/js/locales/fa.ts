const fa = {
    ...
    dashboardPage: {
        ...
        search: 'جستجو',
        searchPlaceholder: 'جستجوی شعبات، موجودی و امور مالی...',
        showAll: 'نمایش همه',
        details: 'جزئیات',
        cards: {
    ...
    properties: {
        ...
        placeholders: {
            ...
            selectProperty: 'شعبه را انتخاب کنید',
        },
        actions: {
        ...
        feedback: {
            propertyCreated: 'شعبه با موفقیت ایجاد شد.',
            propertyUpdated: 'شعبه با موفقیت آپدیت شد.',
            propertyDeleted: 'شعبه با موفقیت حذف شد.',
            propertyDisabled: 'شعبه با موفقیت غیرفعال شد.',
            propertyActivated: 'شعبه با موفقیت فعال شد.',
        ...
        modals: {
            ...
            edit: {
                title: 'ویرایش شعبه',
                description: 'اطلاعات و موقعیت شعبه را آپدیت کنید.',
            },
            tables: {
    ...
    users: {
        ...
        filters: {
            ...
            allCountries: 'تمام کشورها',
            allCities: 'تمام شهرها',
            allProperties: 'تمام شعبات',
            searchRoles: 'جستجوی نقش‌ها...',
            searchCountries: 'جستجوی کشورها...',
            searchCities: 'جستجوی شهرها...',
            searchProperties: 'جستجوی شعبات...',
            noRolesFound: 'هیچ نقشی یافت نشد.',
            noCountriesFound: 'هیچ کشوری یافت نشد.',
            noCitiesFound: 'هیچ شهری یافت نشد.',
            noPropertiesFound: 'هیچ شعبه‌ای یافت نشد.',
        },
        fields: {
            name: 'نام',
            email: 'ایمیل',
    ...
    employees: {
        page: {
            ...
            selectPropertyForStats: 'شعبه را برای آمار انتخاب کنید',
        ...
        filters: {
            ...
            searchProperties: 'شعبات را جستجو کنید...',
            ...
            noProperties: 'هیچ شعبه‌ای یافت نشد.',
    ...
    financeDashboard: {
        ...
        charts: {
            ...
            propertyRevenueTitle: 'درآمد به تفکیک شعبه',
    ...
    financeInventoryValuation: {
        ...
        filters: {
            ...
            selectProperty: 'شعبه را انتخاب کنید',
            searchProperties: 'جستجوی شعبات...',
            noPropertyFound: 'هیچ شعبه‌ای یافت نشد.',
        },
        summary: {
            inventoryValue: 'ارزش موجودی',
    ...
    financeCashBank: {
        ...
        form: {
            ...
            sourceProperty: 'شعبه مبدأ',
            selectSourceProperty: 'شعبه مبدأ را انتخاب کنید',
            destinationProperty: 'شعبه مقصد',
            selectDestinationProperty: 'شعبه مقصد را انتخاب کنید',
    ...
    inventory: {
        page: {
            title: 'موجودی',
            propertyStatsPlaceholder: 'برای آمار، شعبه را انتخاب کنید',
            allProperties: 'همه شعبه‌ها',
            stats: {
    ...
    propertyWorkspace: {
        ...
        registerHelp: 'ابتدا پروفایل را ایجاد کنید؛ منزل‌ها و ساحات کرایی بعداً افزوده می‌شوند.',
        edit: 'ویرایش جایداد',
        ...
        relatedHelp: 'هنگام ثبت موقعیت دیگر در ولایت یا کشور متفاوت، جایداد اصلی را انتخاب کنید.',
        ...
        noFloors: 'هنوز منزلی ثبت نشده است. از زیرزمین، منزل همکف یا منزل بالا آغاز کنید.',
        noSpaces: 'هنوز :spaces ثبت نشده است.',
        deleteFloor: 'این منزل و تمام ساحات آن حذف شود؟',
        deleteSpace: 'این ساحه حذف شود؟',
        houseHelp: 'جزئیات خانه در سطح جایداد مدیریت می‌شود و بعداً تمام خانه به یک قرارداد کرایی سپرده می‌شود.',
        fields: {
            name: 'نام', type: 'نوع جایداد', usage: 'نوع استفاده', country: 'کشور', province: 'ولایت',
            photo: 'تصویر', address: 'آدرس', description: 'توضیحات', distance: 'فاصله از شهر (کیلومتر)',
            landArea: 'مساحت زمین (متر مربع)', buildingArea: 'مساحت تعمیر (متر مربع)', floors: 'تعداد منزل‌ها',
            expectedShops: 'تعداد احتمالی دکان‌ها', expectedApartments: 'تعداد احتمالی آپارتمان‌ها', parking: 'تعداد پارکینگ',
            rooms: 'اتاق‌ها', kitchens: 'آشپزخانه‌ها', halls: 'هال‌ها', bathrooms: 'تشناب‌ها', floorName: 'نام منزل',
            levelNumber: 'نمبر منزل', area: 'مساحت (متر مربع)', plannedSpaces: 'ساحات پلان‌شده', width: 'عرض (متر)',
            length: 'طول (متر)', electricityMeter: 'میتر برق', waterMeter: 'میتر آب',
            shopNumber: 'نمبر دکان', apartmentNumber: 'نمبر آپارتمان',
        },
        ...
        types: { market: 'مارکیت', mall: 'مال', block: 'بلاک رهایشی', house: 'خانه' },
        ...
        save: 'ذخیره تغییرات',
        create: 'ثبت جایداد',
        employees: 'کارمندان', employeesHelp: 'تعیین کارمندان و معاشات برای این جایداد',
        expenses: 'مصارف', expensesHelp: 'ثبت مصارف حفظ و مراقبت و فعالیت‌ها',
        shareholders: 'سهام‌داران', shareholdersHelp: 'محیط مدیریت مالکیت و توزیع سهم',
        rentContracts: 'کرایه و قراردادها', rentContractsHelp: 'مستأجران، قراردادها و جمع‌آوری پرداخت‌ها',
