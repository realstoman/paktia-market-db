const fa = {
    ...
    navigation: {
        ...
        toolInventory: 'گدام',
        toolDubaiRestaurant: 'رستورانت کابل دربار',
        toolKabulSarafi: 'صرافی عبدالحنان پکتیاوال',
    ...
    activityLogsPage: {
        ...
        table: {
            ...
            details: 'جزئیات',
            view: 'مشاهده',
            empty: 'هیچ فعالیتی مطابق این فلترها پیدا نشد.',
            system: 'سیستم',
        },
        archives: {
    ...
    tenants: {
        ...
        subtitle:
            'ثبت دکانداران، واگذاری دکان و جایداد، و نگهداری قرارداد ها و اسناد در یک محل.',
        register: 'ثبت مستأجر جدید',
        scan: 'سکن کارت مستأجر',
        scanPlaceholder: 'کارت را سکن یا کُد آن را وارد کنید…',
        scanHelp: 'با سکن بارکُد چاپ‌شده، پروفایل مستأجر فوراً باز می‌شود.',
        scanCameraTitle: 'سکن بارکُد',
        scanCameraDescription:
            'از کمره دستگاه برای خواندن بارکُد چاپ‌شده روی کارت مستأجر استفاده کنید.',
        scanCameraStarting: 'کمره در حال فعال شدن است…',
        scanCameraReady: 'کمره را به طرف بارکُد کارت مستأجر بگیرید.',
        scanCameraUnavailable:
            'سکن با کمره در این مرورگر قابل دسترس نیست. لطفاً با دستگاه بارکُدخوان سکن کنید یا کُد کارت را دستی وارد کنید.',
        scanNotSupported:
            'این مرورگر خواندن بارکُد از طریق کمره را پشتیبانی نمی‌کند. لطفاً از ورودی سکن یا دستگاه بارکُدخوان استفاده کنید.',
        scanPermissionDenied:
            'اجازه دسترسی به کمره داده نشد یا کمره باز نشد. لطفاً کُد کارت را دستی وارد کنید.',
        scanDetected: 'کارت مستأجر سکن شد.',
        scanManualEntry: 'وارد کردن کُد به شکل دستی',
        ...
        individual: 'شخص',
        company: 'شرکت',
        identity: 'معلومات هویت و تجارت',
        contact: 'معلومات تماس',
        total: 'مستأجران ثبت‌ شده',
        assigned: 'محل‌های واگذارشده',
        persons: 'اشخاص ثبت شده',
        businesses: 'تجارت ‌ها',
        properties: 'املاک مربوط',
        rentedProperties: 'املاک کرایه شده',
        viewProfile: 'مشاهده پروفایل',
        editProfile: 'تغیر دادن معلومات',
        statusAction: 'تغیر حالت',
        filters: {
            property: 'فیلتر بر اساس جایداد',
            allProperties: 'همه املاک',
            searchProperties: 'جستجوی املاک...',
            noPropertiesFound: 'هیچ جایدادی یافت نشد.',
            renterType: 'نوع مستأجر',
            allRenters: 'همه مستأجران',
            business: 'تجارت / دکان',
            person: 'شخص',
            searchRenterTypes: 'جستجوی نوع مستأجر...',
            noRenterTypesFound: 'نوعی یافت نشد.',
        },
        table: {
            owner: 'کرایه گیرنده / شخص مسئول',
            business: 'نام تجارت',
            shop: 'دکان / دفتر',
            space: 'دکان / آپارتمان',
            property: 'جایداد',
        ...
        fields: {
            tenantType: 'نوع کرایه گیرنده',
            fullName: 'نام کامل / شخص مسئول',
            fatherName: 'نام پدر',
            businessName: 'نام تجارت / شرکت',
            phone: 'شماره تماس',
            whatsapp: 'شماره وتس اپ',
            email: 'ایمیل آدرس',
            nid: 'نمبر تذکره',
            license: 'نمبر جواز تجارت',
            address: 'آدرس',
            photo: 'عکس شخص مسئول',
            documents: 'تذکره، جواز و اسناد دیگر',
            documentsHelp:
                'حداکثر ۵ فایل؛ مجموع حجم فایل‌ها نباید از ۲MB بیشتر شود.',
            documentsMaxFiles: 'حداکثر :count فایل را انتخاب کنید.',
            documentsMaxSize: 'مجموع حجم اسناد نباید از ۲MB بیشتر شود.',
            notes: 'معلومات اضافی',
            select: 'انتخاب کنید',
        },
        lease: {
            title: 'واگذاری دکان، آپارتمان یا جایداد دیگر',
            optional: 'هنگام ثبت اختیاری است',
            add: 'قرارداد جدید',
            edit: 'ویرایش قرارداد',
            save: 'ذخیره قرارداد',
            printCard: 'چاپ کارت همین قرارداد',
            property: 'مارکیت یا مجتمع',
            space: 'دکان، آپارتمان یا ملک',
            wholeProperty: 'تمام جایداد',
            startDate: 'تاریخ عقد قرارداد',
        ...
        card: {
            ...
            scanHelp: 'برای بازکردن پروفایل سکن کنید',
        },
    },
    contractTemplates: {
    ...
    leaseContract: {
        ...
        signedHelp:
            'پس از چاپ، امضاء و مهر، نسخه سکن‌شده قرارداد را بارگذاری کنید.',
        signedAt: 'تاریخ امضاء',
        document: 'فایل PDF یا سکن امضاءشده',
    ...
    propertyDashboard: {
        ...
        inactiveProjects: 'مارکیت ها و املاک غیرفعال',
        ...
        portfolioStatusHelp: 'مارکیت ها و املاک فعال و غیرفعال',
        noFinanceData: 'هنوز ریکارد مالی موجود نیست.',
        noProjectData: 'هنوز پروژه‌ای ثبت نشده است.',
        projects: 'مارکیت ها و املاک',
        project: 'مارکیت یا املاک',
        projectsFinanceOverview: 'خلاصه مالی مارکیت‌ها و املاک',
        projectsFinanceOverviewHelp:
            'کرایه ماه جاری، مجموع کرایه جمع‌آوری‌شده، مصارف و وضعیت هر جایداد.',
        propertyName: 'نام جایداد',
        recentMonthRent: 'کرایه ماه جاری',
        totalCollectedRent: 'مجموع کرایه جمع‌آوری‌شده',
        ...
        viewExpenses: 'مشاهده مصارف',
        totalShareholderTakeoutsThisMonth: 'برداشت سهمداران این ماه',
        totalAvailableCash: 'موجودی نقد قابل دسترس',
        monthlyFinanceChart: 'خلاصه مالی ماهانه',
        monthlyFinanceChartHelp:
            'کرایه جمع‌آوری‌شده، مصارف، برداشت سهمداران و موجودی نقد این ماه',
        propertyStructureChart: 'ساختار جایداد',
        propertyStructureChartHelp:
            'منزل‌ها، دکان‌ها، دکان‌های کرایه‌شده و دکان‌های خالی',
        recentCollectedRent: 'آخرین کرایه‌های جمع‌آوری‌شده',
        recentCollectedRentHelp:
            'آخرین پرداخت‌های کرایه از دکان‌ها و ساحات کرایه‌شده',
        receipt: 'رسید',
        shop: 'دکان',
        tenant: 'کرایه‌نشین',
        period: 'دوره',
        noRecentRent: 'هنوز برای این جایداد کرایه‌ای جمع‌آوری نشده است.',
    ...
    settings: {
        ...
        twoFactorEnabledModalDescription:
            'احراز هویت دو مرحله‌ای اکنون فعال است. کد QR را سکن کنید یا کلید تنظیم را در برنامه تأییدکننده خود وارد کنید.',
        ...
        enableTwoFactorModalDescription:
            'برای تکمیل فعال‌سازی احراز هویت دو مرحله‌ای، کد QR را سکن کنید یا کلید تنظیم را در برنامه تأییدکننده خود وارد کنید',
    ...
    reportPage: {
        ...
        toolbar: {
            ...
            period: 'دوره',
            property: 'مارکیت',
            draft: 'تغییرات ممفاده تطبیق نشده است',
        ...
        table: {
            ...
            noRows: 'هیچ ردیفی با جستجو یا فلترهای شما مطابقت ندارد.',
            planned:
    ...
    employees: {
        ...
        employmentTypes: {
            ...
            managerDescription:
                'نوعیت‌های استخدام را اضافه، تغیر دادن و حذف کنید.',
            typeName: 'نام نوعیت',
        ...
        shifts: {
            ...
            managerDescription:
                'شیفت‌های کارمندان را اضافه، تغیر دادن و حذف کنید.',
            shiftName: 'نام شیفت',
        ...
        positions: {
            ...
            managerDescription:
                'سمت‌های کارمندان را اضافه، تغیر دادن و حذف کنید.',
    ...
    rentals: {
        ...
        summary: {
            ...
            contractCoverage: ':signed امضاءشده · :unsigned بدون سکن',
        },
        fields: {
            property: 'جایداد',
    ...
    financeDashboard: {
        ...
        projection: {
            ...
            transactionalFallback:
                'این نمای فیلترشده از خوانش‌های معاملاتی استفاده می‌کند، زیرا فلترهای انتخاب‌شده از جزئیات فعلی پروجکشن دقیق‌تر هستند.',
        ...
        notes: {
            ...
            grossProfitPosted:
                'مفاد ناخالص با استفاده از حرکات ثبت‌شده بهای موجودی محاسبه می‌شود.',
            grossProfitPending:
                'داده‌های بهای موجودی هنوز کامل نیست، بنابراین مفاد ناخالص تا تکمیل پوشش ارزش‌گذاری موجودی در انتظار می‌ماند.',
            cashPosition:
        ...
        charts: {
            ...
            noExpenseCategories:
                'برای فلترهای انتخاب‌شده هیچ کتگوری مصرفی یافت نشد.',
        },
        ledger: {
            title: 'آمادگی دفترکل',
            description:
        ...
        modules: {
            ...
            description:
                'بخش‌های مالی را از اینجا باز کنید تا فلترهای داشبورد روی تحلیل‌ها متمرکز بمانند.',
            names: {
        ...
        shareholderPnl: {
            title: 'مفاد و زیان سهمداران',
            description:
                'نتیجه مالی جایداد در دوره انتخاب‌شده بر اساس فیصدی مؤثر سهم تخصیص می‌گردد.',
            shareholder: 'سهامدار',
            property: 'جایداد',
            share: 'فیصدی سهم',
            net: 'مفاد و زیان جایداد',
            allocated: 'مفاد و زیان سهمدار',
        ...
        generalLedger: {
            ...
            empty: 'برای فلترهای انتخاب‌شده هیچ ثبت تازه دفترکل یافت نشد.',
            status: {
                posted: 'ثبت‌شده',
                approved: 'تاییدشده',
                submitted: 'ارسال‌شده',
        ...
        quickCards: {
            ...
            propertyControl: {
                ...
                description:
                    'گزارش‌گیری یکپارچه با فلترها و مانده‌های سطح جایداد',
            },
            cashBank: {
                title: 'نقد و بانک',
    ...
    financeInventoryValuation: {
        ...
        movements: {
            ...
            empty: 'برای فلترهای انتخاب‌شده هیچ حرکت مالی موجودی یافت نشد.',
        },
        pagination: {
    ...
    financeChartOfAccounts: {
        ...
        ledgerAccounts: {
            ...
            description:
                'همان ساختار جدول مصارف مالی با جستجو، فلترها، صفحه‌بندی و عملیات هر ردیف.',
        },
        filters: {
            type: 'نوع',
            status: 'وضعیت',
        ...
        form: {
            ...
            editTitle: 'تغیر دادن حساب دفترکل',
            description:
    ...
    financeGeneralLedger: {
        ...
        entries: {
            ...
            description: 'جریان کامل مالی عملیاتی برای فلترهای انتخاب‌شده.',
            summary: ' نمایش :from تا :to از :total ثبت.',
            empty: 'برای فلترهای انتخاب‌شده هیچ ثبت دفترکلی یافت نشد.',
        },
        pagination: {
    ...
    financeExpenses: {
        ...
        review: {
            ...
            description:
                'تایید کنید که می‌خواهید این مصرف را تایید کنید یا برای اصلاح برگردانید. مصارف تاییدشده بعداً قابل لغو هستند، اما قابل تغیر دادن نیستند.',
        },
        print: {
    ...
    financeExpenseCategories: {
        ...
        register: {
            ...
            description:
                'همان سیستم جدولی ثبت مصرف، همراه با جستجو، فلترها، صفحه‌بندی و عملیات مدیریت کتگوری.',
        },
        filters: {
            status: 'وضعیت',
        ...
        form: {
            ...
            editTitle: 'تغیر دادن کتگوری مصرف',
            description:
    ...
    financeEmployeeAdvances: {
        ...
        records: {
            ...
            description:
                'پیش‌پرداخت‌های اخیر کارمندان با جستجوی جدول، فلترها، عملیات و ۱۰ ردیف در هر صفحه.',
            searchPlaceholder:
        ...
        form: {
            ...
            editTitle: 'تغیر دادن پیش‌پرداخت کارمند',
            description:
    ...
    inventory: {
        ...
        typeModal: {
            ...
            editTitle: 'تغیر دادن نوع موجودی',
        ...
        rowActions: {
            ...
            editTitle: 'تغیر دادن قلم موجودی',
    ...
    countryManagement: {
        ...
        editCountryTitle: 'تغیر دادن کشور',
        editCountryHelp:
    ...
    propertyWorkspace: {
        ...
        edit: 'تغیر دادن جایداد',
        editTitle: 'تغیر دادن معلومات جایداد',
        editNamedTitle: 'تغیر دادن معلومات :name',
        editHelp: 'معلومات جایداد، موقعیت و مشخصات فزیکی را در سیستم ثبت کنید.',
        ...
        shopsAndApartments: 'دکان‌ها و آپارتمان‌ها',
        rooms: 'اتاق‌ها',
        ...
        addSpace: 'افزودن دکان / آپارتمان',
        addShop: 'افزودن دکان',
        addApartment: 'افزودن آپارتمان',
        editFloor: 'تغیر دادن منزل',
        editSpace: 'تغیر دادن دکان / آپارتمان',
        editShop: 'تغیر دادن دکان',
        editApartment: 'تغیر دادن آپارتمان',
        saveChanges: 'ذخیره تغییرات',
        noFloors:
            'هنوز منزلی ثبت نشده است. از زیرزمین، منزل همکف یا منزل بالا آغاز کنید.',
        noSpaces: 'هنوز :spaces ثبت نشده است.',
        searchSpaces: 'جستجوی دکان یا آپارتمان با نمبر یا نام…',
        ...
        uploadPhotoHelp:
            'PNG، JPG یا WebP تا حجم ۵ مگابایت؛ هر اندازه تصویر پذیرفته می‌شود و در کارت‌ها خودکار برش می‌خورد.',
        ...
        typeBehaviors: {
            market: 'مارکیت / مرکز خرید دارای دکان‌ها',
            block: 'بلاک رهایشی دارای آپارتمان‌ها',
            house: 'خانه کامل',
            commercial_unit: 'یک دکان / دفتر ملکیت‌شده',
        },
        typesManager: {
            title: 'مدیریت نوعیت‌های جایداد',
            description:
                'نام نوعیت جایداد را به دری، پشتو و انگلیسی ثبت کنید و مشخص سازید که در سیستم مثل مارکیت، بلاک، خانه یا واحد تجارتی رفتار کند.',
            create: 'ایجاد نوعیت',
            nameFa: 'نام دری',
            namePs: 'نام پشتو',
            nameEn: 'نام انگلیسی',
        ...
        images: {
            title: 'تصاویر جایداد',
            help: 'تا ۱۰ تصویر گالری از زاویه‌های مختلف بارگذاری کنید. کارت‌ها و تصویر اصلی اندازه ثابت دارند و خودکار برش می‌خورند.',
            upload: 'بارگذاری تصاویر',
            image: 'تصویر جایداد',
            cover: 'تصویر اصلی فعلی',
            setCover: 'انتخاب به‌عنوان تصویر اصلی',
            deleteTitle: 'تصویر حذف شود؟',
            deleteDescription: 'این تصویر از گالری جایداد حذف خواهد شد.',
    ...
    shareholders: {
        ...
        ownershipHelp:
            'فیصدی سهم در تاریخ تعیین‌شده اعتبار دارد و بعداً برای محاسبه مفاد و زیان استفاده می‌شود.',
        ...
        profile: {
            ...
            takeouts: 'برداشت‌ها',
            takeoutsHelp:
                'برداشت‌های سهمدار، توزیع مفاد و برداشت سرمایه از همین پروفایل مدیریت خواهد شد.',
    ...
    businessFinance: {
        ...
        businesses: {
            dubaiRestaurant: {
                title: 'رستورانت کابل دربار',
                location: 'دبی، امارات متحده عربی',
                description:
                    'ثبت ارزش روزانه، فروشات، عاید و مصارف برای رستورانت کابل دربار.',
                moduleDescription:
                    'ارزش، فروشات، عاید و مصارف روزانه رستورانت.',
            },
            kabulSarafi: {
                title: 'صرافی عبدالحنان پکتیاوال',
                location: 'کابل، افغانستان',
                description:
                    'ثبت ارزش روزانه، فروشات، عاید و مصارف برای صرافی عبدالحنان پکتیاوال.',
                moduleDescription:
                    'ارزش، فروشات، عاید و مصارف روزانه صرافی.',
            },
        },
        actions: {
