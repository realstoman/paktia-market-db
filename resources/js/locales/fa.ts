const fa = {
    ...
    tenants: {
        ...
        scanHelp: 'با سکن کُد QR، پروفایل مستأجر فوراً باز می‌شود.',
        scanCameraTitle: 'سکن کُد QR',
        scanCameraDescription:
            'از کمره دستگاه برای خواندن کُد QR چاپ‌شده روی کارت مستأجر استفاده کنید.',
        scanCameraStarting: 'کمره در حال فعال شدن است…',
        scanCameraReady: 'کمره را به طرف کُد QR کارت مستأجر بگیرید.',
        scanCameraUnavailable:
            'سکن با کمره در این مرورگر قابل دسترس نیست. لطفاً با دستگاه QR خوان سکن کنید یا کُد کارت را دستی وارد کنید.',
        scanNotSupported:
            'این مرورگر خواندن کُد QR از طریق کمره را پشتیبانی نمی‌کند. لطفاً از ورودی سکن یا دستگاه QR خوان استفاده کنید.',
