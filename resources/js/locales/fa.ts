const fa = {
    ...
    dashboardPage: {
        ...
        search: 'جستجو',
        searchPlaceholder: 'جستجوی جایدادها، موجودی و امور مالی...',
        showAll: 'نمایش همه',
        details: 'جزئیات',
        cards: {
    ...
    properties: {
        page: {
            metaTitle: 'جایدادها',
            title: 'جایدادها مارکیت',
            description: 'جایدادها مارکیت را مدیریت کنید',
        },
        cards: {
            total: {
                title: 'مجموع جایدادها',
                description: 'تمام جایدادها ثبت‌شده در سیستم.',
            },
            active: {
                title: 'جایدادها فعال',
                description: 'جایدادهای که فعلاً فعال هستند.',
            },
            countries: {
                title: 'کشورها',
                description: 'کشورهای مرتبط با عملیات جایدادها.',
            },
        },
        table: {
        ...
        filters: {
            searchPlaceholder:
                'جایدادها را با نام، کشور یا ولایت جستجو کنید...',
    ...
    users: {
        ...
        filters: {
            ...
            searchCountries: 'جستجوی کشورها...',
            searchCities: 'جستجوی شهرها...',
            searchProperties: 'جستجوی جایدادها...',
    ...
    notifications: {
        ...
        empty: {
            ...
            description:
                'آپدیت‌های مارکیت‌ها، جایدادها، کرایه، گدام، مالی، معاش، کارمندان و کاربران در اینجا نمایش داده می‌شوند.',
        },
        emptyCategory: {
    ...
    employees: {
        ...
        filters: {
            ...
            searchProperties: 'جایدادها را جستجو کنید...',
    ...
    financeDashboard: {
        ...
        shareholderPnl: {
            ...
            description: 'نتیجه مالی جایداد در دوره انتخاب‌شده بر اساس فیصدی مؤثر سهم تخصیص می‌گردد.',
            shareholder: 'سهامدار', property: 'جایداد', share: 'فیصدی سهم', net: 'سود و زیان جایداد', allocated: 'سود و زیان سهمدار',
    ...
    financeInventoryValuation: {
        ...
        summary: {
            ...
            inventoryValueDescription:
                'ارزش فعلی موجودی در جایدادها انتخاب‌شده',
    ...
    financeCashBank: {
        ...
        register: {
            ...
            description:
                'تمویل نقدی در دست، تمویل بانکی و انتقال‌ها به پول‌خرد یا سایر جایدادها را اضافه کنید.',
            searchPlaceholder:
    ...
    countryManagement: {
        ...
        subtitle:
            'مدیریت نام‌های محلی کشورها، اسعار، ولایات و جایدادهای مربوط.',
    ...
    propertyWorkspace: {
        ...
        orderTitle: 'ترتیب نمایش جایدادها',
        orderHelp:
            'جایدادهای جدید در آخر فهرست افزوده می‌شوند. ترتیب این صفحه و داشبورد را از اینجا تنظیم کنید.',
    ...
    shareholders: {
        title: 'سهمداران',
        subtitle: 'هویت، اسناد و مالکیت جایدادها در یک محیط مصون و منظم.',
        register: 'ثبت سهمدار',
        edit: 'ویرایش مشخصات',
        manage: 'مدیریت سهم',
        ...
        assigned: 'دارای سهم',
        properties: 'جایدادهای دارای سهمدار',
