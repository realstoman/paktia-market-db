const ps = {
    ...
    tenants: {
        ...
        scanCameraTitle: 'بارکوډ سکین',
        scanCameraDescription:
            'د کرایه‌دار پر کارت چاپ شوی بارکوډ د وسیلې په کمره ولولئ.',
        scanCameraStarting: 'کمره پیلېږي…',
        scanCameraReady: 'کمره د کرایه‌دار کارت بارکوډ ته ونیسئ.',
        scanCameraUnavailable:
            'په دې براوزر کې د کمرې سکین شتون نه لري. مهرباني وکړئ د بارکوډ سکینر وکاروئ یا د کارت کوډ په لاس ولیکئ.',
        scanNotSupported:
            'دا براوزر له کمرې څخه بارکوډ نه شي لوستلای. مهرباني وکړئ د سکین ورودي یا بارکوډ سکینر وکاروئ.',
        ...
        persons: 'ثبت شوي اشخاص',
        businesses: 'سوداګرۍ',
        properties: 'اړوند ملکیتونه',
        rentedProperties: 'کرایه شوي ملکیتونه',
        viewProfile: 'پروفایل کتل',
        editProfile: 'پروفایل سمول',
        statusAction: 'حالت بدلول',
        filters: {
            property: 'د جایداد له مخې فلټر',
            allProperties: 'ټول جایدادونه',
            searchProperties: 'جایدادونه ولټوئ...',
            noPropertiesFound: 'هیڅ جایداد ونه موندل شو.',
            renterType: 'د کرایه‌دار ډول',
            allRenters: 'ټول کرایه‌داران',
            business: 'سوداګري / دوکان',
            person: 'شخص',
            searchRenterTypes: 'د کرایه‌دار ډول ولټوئ...',
            noRenterTypesFound: 'ډول ونه موندل شو.',
        },
        table: {
            owner: 'مالک / مسؤل شخص',
        ...
        fields: {
            ...
            documentsHelp:
                'تر ۵ فایلونو پورې؛ د ټولو فایلونو ګډ حجم باید له ۲MB زیات نه وي.',
            documentsMaxFiles: 'تر :count پورې فایلونه وټاکئ.',
            documentsMaxSize: 'د اسنادو ټول حجم باید له ۲MB زیات نه وي.',
            notes: 'یادښتونه',
            select: 'انتخاب کړئ',
        },
        lease: {
            ...
            add: 'سپارنه زیاتول',
            edit: 'سپارنه سمول',
            save: 'سپارنه خوندي کول',
            printCard: 'د همدې سپارنې کارت چاپ',
    ...
    propertyWorkspace: {
        ...
        editNamedTitle: 'د :name معلومات سمول',
        ...
        typeBehaviors: {
            market: 'مارکېټ / شاپینګ سنټر د دوکانونو سره',
            block: 'استوګنیز بلاک د اپارتمانونو سره',
            house: 'بشپړ کور',
            commercial_unit: 'یو ملکیت شوی دوکان / دفتر',
        },
        typesManager: {
            title: 'د جایداد ډولونو مدیریت',
            description:
                'د جایداد ډول نوم په دري، پښتو او انګلیسي ثبت کړئ او وټاکئ چې په سیستم کې د مارکېټ، بلاک، کور یا سوداګریز واحد په څېر چلند وکړي.',
            create: 'ډول جوړول',
            nameFa: 'دري نوم',
            namePs: 'پښتو نوم',
            nameEn: 'انګلیسي نوم',
