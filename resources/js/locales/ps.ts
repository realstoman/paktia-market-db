const ps = {
    ...
    properties: {
        ...
        feedback: {
            propertyCreated: 'څانګه په بریالیتوب سره جوړه شوه.',
            propertyUpdated: 'څانګه په بریالیتوب سره نوې شوه.',
            propertyDeleted: 'څانګه په بریالیتوب سره حذف شوه.',
            propertyDisabled: 'څانګه په بریالیتوب سره غیرفعاله شوه.',
            propertyActivated: 'څانګه په بریالیتوب سره فعاله شوه.',
    ...
    users: {
        ...
        filters: {
            ...
            allCountries: 'ټول هیوادونه',
            allCities: 'ټول ښارونه',
            allProperties: 'ټولې څانګې',
            searchRoles: 'رولونه وپلټئ...',
            searchCountries: 'هیوادونه وپلټئ...',
            searchCities: 'ښارونه وپلټئ...',
            searchProperties: 'څانګې وپلټئ...',
            noRolesFound: 'هیڅ رول ونه موندل شو.',
            noCountriesFound: 'هیڅ هیواد ونه موندل شو.',
            noCitiesFound: 'هیڅ ښار ونه موندل شو.',
            noPropertiesFound: 'هیڅ څانګه ونه موندل شوه.',
        },
        fields: {
            name: 'نوم',
            email: 'ایمیل',
    ...
    employees: {
        page: {
            ...
            selectPropertyForStats: 'د احصایې لپاره څانګه وټاکئ',
    ...
    financeDashboard: {
        ...
        charts: {
            ...
            propertyRevenueTitle: 'د څانګې له مخې عاید',
    ...
    financeInventoryValuation: {
        ...
        filters: {
            ...
            selectProperty: 'څانګه وټاکئ',
            searchProperties: 'څانګې ولټوئ...',
            noPropertyFound: 'هیڅ څانګه ونه موندل شوه.',
        },
        summary: {
            inventoryValue: 'د موجودۍ ارزښت',
    ...
    financeCashBank: {
        ...
        form: {
            ...
            sourceProperty: 'د مبدأ څانګه',
            selectSourceProperty: 'د مبدأ څانګه وټاکئ',
            destinationProperty: 'د مقصد څانګه',
            selectDestinationProperty: 'د مقصد څانګه وټاکئ',
    ...
    inventory: {
        page: {
            title: 'ذخیره',
            propertyStatsPlaceholder: 'د احصایو لپاره څانګه وټاکئ',
            allProperties: 'ټولې څانګې',
            stats: {
    ...
    propertyWorkspace: {
        ...
        registerHelp: 'لومړی پروفایل جوړ کړئ؛ منزلونه او کرایي ځایونه وروسته زیاتېږي.',
        edit: 'جایداد سمول',
        ...
        relatedHelp: 'په بل ولایت یا هېواد کې د بل موقعیت د ثبت پر مهال اصلي جایداد وټاکئ.',
        ...
        noFloors: 'تر اوسه منزل نشته. له زیرزمین، ځمکني یا پورته منزل څخه پیل وکړئ.',
        noSpaces: 'تر اوسه :spaces نه دي ثبت شوي.',
        deleteFloor: 'دا منزل او ټول ځایونه یې حذف شي؟',
        deleteSpace: 'دا ځای حذف شي؟',
        houseHelp: 'د کور معلومات د جایداد په کچه اداره کېږي او وروسته ټول کور یوه کرایي قرارداد ته سپارل کېږي.',
        fields: {
            name: 'نوم', type: 'د جایداد ډول', usage: 'کارونه', country: 'هېواد', province: 'ولایت',
            photo: 'انځور', address: 'پته', description: 'تشریح', distance: 'له ښار څخه واټن (کیلومتر)',
            landArea: 'د ځمکې مساحت (متر مربع)', buildingArea: 'د ودانۍ مساحت (متر مربع)', floors: 'د منزلونو شمېر',
            expectedShops: 'اټکلي دوکانونه', expectedApartments: 'اټکلي اپارتمانونه', parking: 'پارکینګ ځایونه',
            rooms: 'خونې', kitchens: 'پخلنځي', halls: 'هالونه', bathrooms: 'تشنابونه', floorName: 'د منزل نوم',
            levelNumber: 'د منزل نمبر', area: 'مساحت (متر مربع)', plannedSpaces: 'پلان شوي ځایونه', width: 'پلنوالی (متر)',
            length: 'اوږدوالی (متر)', electricityMeter: 'د برېښنا میتر', waterMeter: 'د اوبو میتر',
            shopNumber: 'د دوکان نمبر', apartmentNumber: 'د اپارتمان نمبر',
        },
        ...
        types: { market: 'مارکېټ', mall: 'مال', block: 'استوګنیز بلاک', house: 'کور' },
        ...
        employees: 'کارکوونکي', employeesHelp: 'دې جایداد ته کارکوونکي او معاشونه وټاکئ',
        expenses: 'لګښتونه', expensesHelp: 'د ساتنې او عملیاتو لګښتونه ثبت کړئ',
        shareholders: 'ونډه‌وال', shareholdersHelp: 'د مالکیت او وېش کاري چاپېریال',
        rentContracts: 'کرایه او قراردادونه', rentContractsHelp: 'کرایه‌داران، قراردادونه او تادیات',
