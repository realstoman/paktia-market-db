const ps = {
    ...
    auth: {
        login: {
            ...
            description:
                'د پکتیاوال ګروپ د مارکیټونو، جایدادونو، ګدام، مالي چارو او ورځنیو مارکیټ عملیاتو د مدیریت سیستم.',
    ...
    notifications: {
        ...
        empty: {
            ...
            description:
                'د مارکېټونو، جایدادونو، کرایو، ګدام، مالي چارو، معاش، کارکوونکو او کارنانو تازه معلومات به دلته ښکاره شي.',
        },
        emptyCategory: {
