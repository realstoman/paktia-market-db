const ps = {
    ...
    printers: {
        description:
            'د شبکې محلي پرنټرونه ثبت کړئ، هغو ته د پخلنځیو یا سټېشنونو دنده وټاکئ، او د څانګې له سرور څخه د حرارتي چاپ اړیکه وازمویئ.',
        newPrinter: 'نوی پرنټر',
        createPrinter: 'پرنټر جوړ کړئ',
        editPrinter: 'پرنټر سم کړئ',
        updatePrinter: 'پرنټر تازه کړئ',
        formDescription:
            'د محلي شبکې پته او هغه دندې خوندي کړئ چې دا پرنټر یې باید ترلاسه کړي.',
        searchPlaceholder: 'د پرنټر نوم، IP پته یا یادښتونه ولټوئ...',
        allBranches: 'ټولې څانګې',
        selectBranch: 'څانګه وټاکئ',
        searchBranches: 'څانګې ولټوئ...',
        noBranchFound: 'هیڅ څانګه ونه موندل شوه.',
        network: 'شبکه (LAN)',
        searchConnectionTypes: 'د اتصال ډولونه ولټوئ...',
        noConnectionTypeFound: 'د اتصال هېڅ ډول ونه موندل شو.',
        searchPaperWidths: 'د کاغذ پلنوالی ولټوئ...',
        noPaperWidthFound: 'د کاغذ هېڅ پلنوالی ونه موندل شو.',
        notesPlaceholder: 'د افغاني خوړو د برخې ترڅنګ د پخلنځي دیوالي پرنټر.',
        assignmentsTitle: 'د پرنټر دندې',
        assignmentsDescription:
            'دا پرنټر له پخلنځیو، د امر له ډولونو، یا سټېشنونو سره وصل کړئ.',
        addAssignment: 'دنده اضافه کړئ',
        assignmentKitchen: 'پخلنځی',
        assignmentOrderTaker: 'امر اخیستونکی',
        assignmentCashier: 'کاشیر',
        assignmentOrderType: 'د امر ډول',
        assignmentGeneric: 'عمومي',
        defaultStation: 'اصلي',
        searchAssignments: 'د دندې ډولونه ولټوئ...',
        noAssignmentFound: 'د دندې هېڅ ډول ونه موندل شو.',
        selectKitchen: 'پخلنځی وټاکئ',
        searchKitchens: 'پخلنځي ولټوئ...',
        noKitchenFound: 'هیڅ پخلنځی ونه موندل شو.',
        selectOrderType: 'د امر ډول وټاکئ',
        searchOrderTypes: 'د امر ډولونه ولټوئ...',
        noOrderTypeFound: 'د امر هېڅ ډول ونه موندل شو.',
        stationPlaceholder: 'د کاشیر مېز ۱',
        deleteTitle: 'پرنټر حذف شي؟',
        deleteDescription:
            'دا کار د پرنټر پته، دندې، او د راتلونکو محلي چاپ مسیرونه له منځه وړي.',
        unassigned: 'بې دندې',
        active: 'فعال',
        inactive: 'غیرفعال',
        fields: {
            ...
            port: 'پورټ',
            copies: 'کاپۍ',
            connectionType: 'د اتصال ډول',
            paperWidth: 'د کاغذ پلنوالی',
            active: 'فعال پرنټر',
            notes: 'یادښتونه',
            assignmentType: 'د دندې ډول',
            kitchen: 'پخلنځی',
            orderType: 'د امر ډول',
            stationLabel: 'د سټېشن نښه',
            assignmentActive: 'فعاله دنده',
        },
        table: {
            name: 'نوم',
            branch: 'څانګه',
        ...
        feedback: {
            created: 'پرنټر په بریالیتوب سره جوړ شو.',
            updated: 'پرنټر په بریالیتوب سره تازه شو.',
            deleted: 'پرنټر په بریالیتوب سره حذف شو.',
            testSent: 'ازمایښتي چاپ په بریالیتوب سره ولېږل شو.',
        },
    },
    clients: {
        title: 'مشتریان',
        ...
        headingDescription:
            'هغه د پیرودونکو حسابونه وګورئ چې له وېب‌سایټ او موبایل اپ څخه همغږي شوي دي، او د هغوی د آرډر فعالیت هم ورسره وڅارئ.',
        searchPlaceholder:
            'مشتریان د نوم، ایمیل، شمیرې، یا د ننوتلو د چمتو کوونکي له مخې ولټوئ...',
        table: {
            name: 'نوم',
            email: 'ایمیل',
            phone: 'شمېره',
            ...
            totalOrders: 'آرډرونه',
            websiteOrders: 'وېب‌سایټ',
            mobileOrders: 'موبایل',
            lastOrder: 'وروستی آرډر',
            status: 'حالت',
            actions: 'عملیات',
        },
        actions: {
        ...
        details: {
            title: 'د مشتری جزئیات',
            description:
                'د مشتری همغږی شوی پروفایل او د هغه د آنلاین آرډر فعالیت وڅېړئ.',
            firebaseUid: 'د فایربیس پېژند',
        ...
        cards: {
            total: {
                title: 'ټول مشتریان',
                description:
                    'ټول د پیرودونکو حسابونه چې له وېب‌سایټ او موبایل اپ څخه همغږي شوي دي.',
            },
            active: {
                title: 'فعال مشتریان',
                description:
                    'د مشتریانو هغه حسابونه چې دا مهال د ننوتلو او آرډر لپاره فعال دي.',
            },
            website: {
                title: 'د وېب‌سایټ مشتریان',
                description:
                    'هغه مشتریان چې لږ تر لږه یې له وېب‌سایټ څخه یو آرډر کړی وي.',
            },
            mobile: {
                title: 'د موبایل اپ مشتریان',
                description:
                    'هغه مشتریان چې لږ تر لږه یې له موبایل اپ څخه یو آرډر کړی وي.',
            },
        },
    },
    toolsLauncher: {
    ...
    products: {
        ...
        filters: {
            ...
            inactive: 'غیرفعال',
            searchCategories: 'کټګورۍ ولټوئ...',
            searchCuisines: 'د خوړو سبکونه ولټوئ...',
            searchKitchens: 'پخلنځي ولټوئ...',
            searchTypes: 'ډولونه ولټوئ...',
            searchStatuses: 'حالتونه ولټوئ...',
            noCategories: 'هیڅ کټګوري ونه موندل شوه.',
            noCuisines: 'هیڅ د خوړو سبک ونه موندل شو.',
