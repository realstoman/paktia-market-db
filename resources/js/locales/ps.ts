const ps = {
    ...
    navigation: {
        ...
        employees: 'کارکوونکي',
        finance: 'مالي',
        marketsProperties: 'مارکیټونه او جایدادونه',
    ...
    activityLogsPage: {
        ...
        subtitle: 'راپورونه د ۳۰ ورځو لپاره ساتل کېږي. زاړه معلومات په لاندې میاشتنیو آرشیفونو کې شته.',
        refresh: 'تازه کول',
        search: 'لټون',
        ...
        pagination: 'له :total ریکارډونو څخه :start تر :end · :page پاڼه له :pages څخه',
        table: {
            when: 'وخت', user: 'کارن', action: 'فعالیت', entity: 'اړوند برخه',
            property: 'ملکیت', ip: 'IP پته', details: 'جزیات', view: 'کتل',
            empty: 'له دغو فلټرونو سره کوم فعالیت ونه موندل شو.', system: 'سیستم',
        },
        archives: {
            title: 'آرشیف شوې دورې',
            subtitle: 'آرشیف شوي راپورونه د اسنادو ساتلو لپاره ښکته کړئ. هر آرشیف یو فشرده میاشتنی فایل دی.',
            empty: 'تر اوسه آرشیف نشته. آرشیفونه هره ورځ د سهار په ۳ بجو جوړېږي.',
            period: 'دوره', records: 'ریکارډونه', size: 'حجم', created: 'د جوړېدو نېټه', download: 'ښکته کول',
        },
        drawer: {
            batch: 'ډله', property: 'ملکیت', additionalContext: 'اضافي معلومات',
        },
        show: {
            pageTitle: 'د فعالیت راپور شمېره :id', back: 'لړلیک ته ستنېدل', method: 'طریقه',
            changes: 'بدلونونه', context: 'اضافي جزیات', userAgent: 'د براوزر معلومات',
        },
        diff: {
            empty: 'د فیلډونو کوم جزیي بدلون نه دی ثبت شوی.', field: 'فیلډ', before: 'پخوانی ارزښت', after: 'نوی ارزښت',
        },
        actions: {
            created: 'جوړ شو', updated: 'سم شو', deleted: 'ړنګ شو', restored: 'بېرته راوګرځېد',
            login: 'سیستم ته ننوتل', logout: 'له سیستم څخه وتل', loginFailed: 'ناکامه ننوتنه', lockout: 'حساب بند شو',
            passwordReset: 'پټنوم بیا وټاکل شو', registered: 'ثبت شو', emailVerified: 'برېښنالیک تایید شو',
            twoFactorEnabled: 'دوه پړاوه تایید فعال شو', twoFactorConfirmed: 'دوه پړاوه تایید تصدیق شو',
            twoFactorDisabled: 'دوه پړاوه تایید غیرفعال شو', twoFactorFailed: 'دوه پړاوه تایید ناکام شو',
            recoveryCodesGenerated: 'د بېرته ترلاسه کولو کوډونه جوړ شول',
        },
        entities: {
            InventoryItem: 'د موجودۍ توکی', InventoryTransaction: 'د موجودۍ راکړه ورکړه', Expense: 'لګښت',
            CashMovement: 'نغدي خوځښت', Employee: 'کارکوونکی', EmployeeContract: 'د کارکوونکي قرارداد',
            EmployeeAdvance: 'د کارکوونکي پیشکي', PayrollRun: 'د معاش دوره', PayrollRunItem: 'د معاش توکی',
            Property: 'ملکیت', User: 'کارن', SystemSetting: 'د سیستم تنظیم', Tenant: 'کرایه‌دار',
            Lease: 'د کرایې قرارداد', Shareholder: 'ونډه‌وال', PropertyShareholding: 'د ملکیت ونډه',
        },
        fields: {
            id: 'پېژند', name: 'نوم', full_name: 'بشپړ نوم', email: 'برېښنالیک', phone: 'تلیفون',
            address: 'پته', description: 'تشریح', status: 'حالت', amount: 'اندازه',
            is_active: 'فعال', property_id: 'ملکیت', user_id: 'کارن', created_at: 'د جوړېدو وخت',
            updated_at: 'د سمېدو وخت', deleted_at: 'د ړنګېدو وخت', business_name: 'د سوداګرۍ نوم',
            nid_number: 'د تذکرې شمېره', license_number: 'د جواز شمېره', percentage: 'سلنه',
        },
    },
    tenants: {
