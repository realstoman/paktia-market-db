  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        isRtl && "flex-row-reverse justify-end text-right data-[inset]:pr-8 data-[inset]:pl-2",
        className
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem
      ...
      className={cn(
        ...
        isRtl && "justify-end pr-8 pl-2 text-right",
        className
      )}
      checked={checked}
      {...props}
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      className={cn(
        ...
        isRtl && "text-right data-[inset]:pr-8 data-[inset]:pl-2",
        className
      )}
      {...props}
    />
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        isRtl && "flex-row-reverse text-right data-[inset]:pr-8 data-[inset]:pl-2",
        className
      )}
      {...props}
    >
      {children}
      <ChevronRightIcon className={cn("ml-auto size-4", isRtl && "mr-auto ml-0 rotate-180")} />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
