    ...
    return (
        <>
            ...
            <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-neutral-100 px-4 py-10 dark:bg-neutral-950">
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,#102F3314,transparent_45%),radial-gradient(circle_at_bottom_right,#CC924B18,transparent_35%)] dark:bg-[radial-gradient(circle_at_top,#ffffff10,transparent_30%),radial-gradient(circle_at_bottom_right,#ffffff08,transparent_25%)]" />
                        ...
                        <div className="mb-6 flex items-start justify-between gap-4">
                            <div>
                                ...
                                <div className="mt-4 flex items-center gap-4">
                                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#102F33] text-white shadow-lg shadow-[#102F33]/20">
