...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'customer_session.cookie_name' => 'string',
            'customer_session.ttl_minutes' => 'integer',
            'customer_session.domain' => 'string',
            'customer_session.secure' => 'boolean',
            'customer_session.same_site' => 'string',
            ...
            'filesystems.links./Users/stoman/Herd/paktia-market-db/public/storage' => 'string',
            ...
            'localization.cookie_name' => 'string',
            'localization.supported.en.label' => 'string',
            'localization.supported.en.native_label' => 'string',
            'localization.supported.en.direction' => 'string',
            'localization.supported.en.is_default' => 'boolean',
            'localization.supported.fa.label' => 'string',
            'localization.supported.fa.native_label' => 'string',
            'localization.supported.fa.direction' => 'string',
            'localization.supported.fa.is_default' => 'boolean',
            'localization.supported.ps.label' => 'string',
            'localization.supported.ps.native_label' => 'string',
            'localization.supported.ps.direction' => 'string',
            'localization.supported.ps.is_default' => 'boolean',
            ...
            'mobile.apps.0.key' => 'NULL',
            'mobile.apps.0.platform' => 'string',
            'mobile.apps.0.active' => 'boolean',
            'mobile.apps.1.key' => 'NULL',
            'mobile.apps.1.platform' => 'string',
            'mobile.apps.1.active' => 'boolean',
            'mobile.guest.expires_in_days' => 'integer',
            'mobile.firebase.project_id' => 'string',
            'mobile.firebase.keys_url' => 'string',
            'mobile.firebase.keys_cache_seconds' => 'integer',
            'mobile.firebase.stub_mode' => 'boolean',
            ...
            'pos.cache.store' => 'string',
            'pos.cache.ttl_seconds.tool_reference' => 'integer',
            'pos.cache.ttl_seconds.product_categories' => 'integer',
            'pos.cache.ttl_seconds.product_types' => 'integer',
            'pos.sync.credential_ttl_hours' => 'integer',
            'pos.sync.remote_base_url' => 'NULL',
            'pos.sync.remote_branch_id' => 'NULL',
            'pos.sync.remote_branch_token' => 'NULL',
            'pos.sync.chunk_size' => 'integer',
            'pos.sync.http_timeout_seconds' => 'integer',
            'pos.sync.last_used_throttle_seconds' => 'integer',
            'pos.sync.min_token_length' => 'integer',
            'pos.sync.allow_wildcard_ability' => 'boolean',
            'pos.projection.health.stale_after_minutes' => 'integer',
            'pos.projection.health.critical_after_minutes' => 'integer',
            'pos.projection.health.recent_activity_hours' => 'integer',
            'pos.runtime_health.queue.warning_pending_jobs' => 'integer',
            'pos.runtime_health.queue.critical_pending_jobs' => 'integer',
            'pos.runtime_health.queue.warning_failed_jobs' => 'integer',
            'pos.runtime_health.queue.critical_failed_jobs' => 'integer',
            'pos.runtime_health.sync.stale_after_hours' => 'integer',
            'pos.runtime_health.recent_refresh.warning_after_minutes' => 'integer',
            'pos.runtime_health.recent_refresh.critical_after_minutes' => 'integer',
            'pos.retention.idempotency_days' => 'integer',
            'pos.retention.sync_credentials_days' => 'integer',
            'pos.retention.projection_days' => 'integer',
            'pos.retention.audit_days' => 'integer',
            'pos.retention.audit_archive_disk' => 'string',
            'pos.retention.audit_archive_path' => 'string',
            'pos.audit.use_queue' => 'boolean',
            'pos.audit.queue' => 'string',
            'pos.exports.async' => 'boolean',
            'pos.exports.queue' => 'string',
            'pos.exports.disk' => 'string',
            'pos.exports.path' => 'string',
            ...
            'security.headers.permissions_policy' => 'string',
            'security.headers.cross_origin_opener_policy' => 'string',
            'security.headers.cross_origin_resource_policy' => 'string',
            'security.headers.hsts_enabled' => 'boolean',
            'security.headers.hsts_max_age' => 'integer',
            'security.headers.hsts_include_subdomains' => 'boolean',
            'security.headers.hsts_preload' => 'boolean',
            'security.headers.content_security_policy' => 'NULL',
...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','customer_session.cookie_name',
'customer_session.ttl_minutes','customer_session.domain','customer_session.secure','customer_session.same_site','database.default',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/stoman/Herd/paktia-market-db/public/storage',
...
'fortify.passkeys.timeout','fortify.features','inertia.ssr.enabled','inertia.ssr.url','inertia.ensure_pages_exist',
...
'inertia.testing.page_extensions','inertia.history.encrypt','localization.cookie_name','localization.supported.en.label','localization.supported.en.native_label',
'localization.supported.en.direction','localization.supported.en.is_default','localization.supported.fa.label','localization.supported.fa.native_label','localization.supported.fa.direction',
'localization.supported.fa.is_default','localization.supported.ps.label','localization.supported.ps.native_label','localization.supported.ps.direction','localization.supported.ps.is_default',
...
'mail.markdown.theme','mail.markdown.paths','mail.markdown.extensions','mobile.apps.0.key','mobile.apps.0.platform',
'mobile.apps.0.active','mobile.apps.1.key','mobile.apps.1.platform','mobile.apps.1.active','mobile.guest.expires_in_days',
'mobile.firebase.project_id','mobile.firebase.keys_url','mobile.firebase.keys_cache_seconds','mobile.firebase.stub_mode','permission.models.permission',
...
'permission.cache.key','permission.cache.store','pos.cache.store','pos.cache.ttl_seconds.tool_reference','pos.cache.ttl_seconds.product_categories',
'pos.cache.ttl_seconds.product_types','pos.sync.credential_ttl_hours','pos.sync.remote_base_url','pos.sync.remote_branch_id','pos.sync.remote_branch_token',
'pos.sync.chunk_size','pos.sync.http_timeout_seconds','pos.sync.last_used_throttle_seconds','pos.sync.min_token_length','pos.sync.allow_wildcard_ability',
'pos.projection.health.stale_after_minutes','pos.projection.health.critical_after_minutes','pos.projection.health.recent_activity_hours','pos.runtime_health.queue.warning_pending_jobs','pos.runtime_health.queue.critical_pending_jobs',
'pos.runtime_health.queue.warning_failed_jobs','pos.runtime_health.queue.critical_failed_jobs','pos.runtime_health.sync.stale_after_hours','pos.runtime_health.recent_refresh.warning_after_minutes','pos.runtime_health.recent_refresh.critical_after_minutes',
'pos.retention.idempotency_days','pos.retention.sync_credentials_days','pos.retention.projection_days','pos.retention.audit_days','pos.retention.audit_archive_disk',
'pos.retention.audit_archive_path','pos.audit.use_queue','pos.audit.queue','pos.exports.async','pos.exports.queue',
'pos.exports.disk','pos.exports.path','queue.default','queue.connections.sync.driver','queue.connections.database.driver',
...
'sanctum.middleware.validate_csrf_token','security.headers.x_content_type_options','security.headers.x_frame_options','security.headers.referrer_policy','security.headers.permissions_policy',
'security.headers.cross_origin_opener_policy','security.headers.cross_origin_resource_policy','security.headers.hsts_enabled','security.headers.hsts_max_age','security.headers.hsts_include_subdomains',
'security.headers.hsts_preload','security.headers.content_security_policy','services.postmark.key','services.resend.key','services.ses.key',
...
'dompdf.options.enable_html5_parser','passkeys.relying_party_id','passkeys.allowed_origins','passkeys.user_handle_secret','passkeys.timeout',
...
'query-builder.convert_relation_names_to_snake_case_plural','query-builder.convert_relation_table_name_strategy','query-builder.convert_field_names_to_snake_case','ide-helper.filename','ide-helper.models_filename',
...
'signed','throttle','verified','app.auth','customer.auth',
'branch.sync','resolve.guest','resolve.firebase','firebase.auth','cart.actor',
'client.auth','idempotency','role','permission','role_or_permission',);
        registerArgumentsSet('routes', 
'login','login.store','logout','password.request','password.reset',
'password.email','password.update','verification.notice','verification.verify','verification.send',
...
'two-factor.recovery-codes','two-factor.regenerate-recovery-codes','sanctum.csrf-cookie','api.v1.orders.index','api.v1.orders.show',
'api.v1.banners.index','api.v1.banners.show','api.v1.digital-tablet-menu.products.index','api.v1.digital-tablet-menu.categories.index','api.v1.digital-tablet-menu.cuisines.index',
'api.v1.digital-tablet-menu.categories.products','api.v1.digital-tablet-menu.cuisines.products','api.v1.digital-tablet-menu.types.index','api.v1.digital-tablet-menu.types.products','api.v1.products.categories.index',
'api.v1.products.categories.show','api.v1.products.categories.products','api.v1.products.cuisines.index','api.v1.products.cuisines.show','api.v1.products.cuisines.products',
'api.v1.products.types.index','api.v1.products.types.show','api.v1.products.types.products','api.v1.products.top-ordered-dishes','api.v1.products.index',
'api.v1.products.show','api.v1.customer-auth.login','api.v1.customer-auth.logout','api.v1.customer.me.show','api.v1.customer.me.update',
'api.v1.customer.me.orders.index','api.v1.customer.me.orders.show','api.v1.customer.me.orders.status','api.v1.customer.cart.show','api.v1.customer.cart.items.store',
'api.v1.customer.cart.items.update','api.v1.customer.cart.items.destroy','api.v1.customer.checkout.store','api.v1.','api.v1.generated::SKptnWY1NwhCppYD',
'api.v1.generated::VNUWjHxRLoM1oQSL','api.v1.generated::Fw9fxXo6l2bEe5K4','api.v1.generated::9pXLHKzQLducSNRP','api.v1.generated::gXvBN7ODRI7ngWfP','api.v1.mobile.products.categories.index',
'api.v1.mobile.products.categories.show','api.v1.mobile.products.categories.products','api.v1.mobile.products.types.index','api.v1.mobile.products.types.show','api.v1.mobile.products.types.products',
'api.v1.mobile.products.top-ordered-dishes','api.v1.mobile.products.index','api.v1.mobile.products.show','api.v1.mobile.guest.session.store','api.v1.mobile.auth.firebase.sync',
'api.v1.mobile.cart.show','api.v1.mobile.cart.items.store','api.v1.mobile.cart.items.update','api.v1.mobile.cart.items.destroy','api.v1.mobile.me.show',
'api.v1.mobile.me.orders.index','api.v1.mobile.me.orders.show','api.v1.mobile.me.orders.status','api.v1.mobile.checkout.store','api.v1.branch-sync.runtime-health',
'api.v1.branch-sync.orders.inbound','api.v1.branch-sync.orders.outbound','generated::waPzuL72fPriPqT3','generated::3t1yUSvVQ6XxcdW2','language.switch',
'tools.reference-data','operations.runtime-health','kitchen.order-items.bulk.start','kitchen.order-items.bulk.ready','kitchen.order-items.bulk.delivered',
'kitchen.order-items.start','kitchen.order-items.ready','kitchen.order-items.delivered','dashboard','notifications.index',
'notifications.read-all','notifications.read','users.index','users.create','users.store',
'users.show','users.edit','users.update','users.reset-password','users.block',
'users.destroy','roles.index','roles.create','roles.store','roles.show',
'roles.edit','roles.update','roles.destroy','generated::HDgwVV37HMDBlE7D','permissions.store',
'countries.index','countries.create','countries.store','countries.show','countries.edit',
'countries.update','countries.destroy','countries.disable','provinces.index','provinces.create',
'provinces.store','provinces.show','provinces.edit','provinces.update','provinces.destroy',
'branches.index','branches.create','branches.store','branches.show','branches.edit',
'branches.update','branches.destroy','branch-tables.store','branch-tables.update','branch-tables.destroy',
'branches.kitchens','kitchens.index','kitchens.create','kitchens.store','kitchens.show',
'kitchens.edit','kitchens.update','kitchens.destroy','printers.index','printers.store',
'printers.update','printers.destroy','printers.test-print','kitchens.toggle','kitchens.products',
'kitchen-types.store','kitchen-types.update','kitchen-types.destroy','cuisines.store','cuisines.update',
'cuisines.destroy','kitchen-categories.store','kitchen-categories.update','kitchen-categories.destroy','branches.disable',
'admin.activity-logs.index','admin.activity-logs.archives.download','admin.activity-logs.show','products.index','products.store',
'products.categories.store','products.types.store','products.update','products.categories.update','products.types.update',
'products.destroy','products.categories.destroy','products.types.destroy','products.images.destroy','clients.index',
'orders.index','orders.customers.search','orders.store','orders.update','generated::ZHdR30OyUOmoz12X',
'orders.status.update','orders.table.update','orders.items.store','discount-cards.store','discount-cards.update',
'discount-cards.destroy','reports.index','reports.export.pdf','reports.export.xlsx','reports.exports.download',
'inventory.index','inventory.store','inventory.update','inventory.restock','inventory.usage-cycle.store',
'vendors.store','vendors.update','banners.store','banners.update','currencies.store',
'currencies.update','units.store','units.update','inventory-types.store','inventory-types.update',
'inventory-categories.store','inventory-categories.update','inventory.destroy','vendors.destroy','banners.destroy',
'currencies.destroy','units.destroy','inventory-types.destroy','inventory-categories.destroy','finance.index',
'finance.general-ledger.index','finance.inventory-valuation.index','finance.payroll.index','finance.employee-advances.index','finance.payroll.store',
'finance.payroll.contracts.store','finance.payroll.contracts.update','finance.payroll.contract-schedules.store','finance.payroll.contract-schedules.update','finance.employee-advances.store',
'finance.employee-advances.update','finance.payroll.destroy','finance.payroll.contracts.destroy','finance.payroll.contract-schedules.destroy','finance.payroll.contract-schedules.approve',
'finance.payroll.contract-schedules.reject','finance.payroll.approve','finance.payroll.reject','finance.employee-advances.approve','finance.employee-advances.reject',
'finance.payroll.mark-paid','finance.expenses.index','finance.expenses.store','finance.expenses.update','finance.expenses.approve',
'finance.expenses.reject','finance.chart-of-accounts.index','finance.chart-of-accounts.store','finance.chart-of-accounts.update','finance.cash-bank.index',
'finance.cash-bank.store','finance.cash-bank.update','finance.cash-bank.approve','finance.cash-bank.reject','finance.cash-movement-types.index',
'finance.cash-movement-types.store','finance.cash-movement-types.update','finance.expense-categories.index','finance.expense-categories.store','finance.expense-categories.update',
'finance.chart-of-accounts.destroy','finance.cash-movement-types.destroy','finance.expense-categories.destroy','employees.index','employees.store',
'employee-positions.store','employment-types.store','shifts.store','employees.update','employees.toggle-active',
'employee-positions.update','employment-types.update','shifts.update','employees.destroy','employee-positions.destroy',
'employment-types.destroy','shifts.destroy','generated::j2rVmbzDHYCeQnFz','generated::T7VgQLCWj0tKp8Ab','profile.edit',
'profile.update','profile.destroy','user-password.edit','user-password.update','appearance.edit',
'language.show','language.update','two-factor.show','system-branding.edit','system-branding.update',
'generated::VwUck1Xrrd8e2W9k','generated::bR6vEEHSa9oOT1OE','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'app','reports.pdf','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'validation.custom.attribute-name.rule-name','activity_logs.title','activity_logs.description','activity_logs.filters.search','activity_logs.filters.action',
'activity_logs.filters.entity','activity_logs.filters.user','activity_logs.filters.from','activity_logs.filters.to','activity_logs.filters.reset',
'activity_logs.filters.apply','activity_logs.columns.when','activity_logs.columns.user','activity_logs.columns.action','activity_logs.columns.entity',
'activity_logs.columns.branch','activity_logs.columns.ip','activity_logs.columns.details','activity_logs.detail.changes','activity_logs.detail.context',
'activity_logs.detail.no_changes','activity_logs.detail.back','activity_logs.archives.title','activity_logs.archives.description','activity_logs.archives.empty',
'activity_logs.archives.period','activity_logs.archives.records','activity_logs.archives.size','activity_logs.archives.created','activity_logs.archives.download',
'dashboard.inventory.usable','dashboard.inventory.fixed','dashboard.inventory.other','dashboard.inventory.unassigned','dashboard.attention.critical_projection_branches_title',
'dashboard.attention.critical_projection_branches_detail','dashboard.attention.projection_warnings_title','dashboard.attention.projection_warnings_detail','dashboard.attention.out_of_stock_title','dashboard.attention.out_of_stock_detail',
'dashboard.attention.low_stock_title','dashboard.attention.low_stock_detail','dashboard.attention.cancellation_rate_title','dashboard.attention.cancellation_rate_detail','dashboard.attention.vendor_balances_title',
'dashboard.attention.vendor_balances_detail','dashboard.notes.net_profit_without_cogs','dashboard.notes.net_profit_with_cogs','dashboard.notes.expenses','dashboard.notes.cash_position',
'dashboard.projection.branch_current','dashboard.projection.branch_missing','dashboard.projection.branch_critical','dashboard.projection.branch_warning','dashboard.projection.branch_unavailable',
'dashboard.projection.overall_critical','dashboard.projection.overall_warning','dashboard.projection.overall_unavailable','dashboard.projection.overall_healthy','notifications.flash.title',
'notifications.orders.title','notifications.orders.description','notifications.orders.table_segment','notifications.orders.user_segment','notifications.orders.total_meta',
'notifications.payments.title','notifications.payments.description','notifications.payments.method_fallback','notifications.payments.order_segment','notifications.payments.user_segment',
'notifications.salary.title','notifications.salary.description','notifications.employees.title','notifications.employees.description','notifications.users.title',
'notifications.users.description','notifications.inventory.added_title','notifications.inventory.updated_title','notifications.inventory.added_description','notifications.inventory.updated_description',
'notifications.inventory.qty_meta','notifications.products.added_title','notifications.products.updated_title','notifications.products.added_description','notifications.products.updated_description',);
...
'FIREBASE_PROJECT_ID','FIREBASE_KEYS_CACHE_SECONDS','MOBILE_FIREBASE_STUB_MODE','FRONTEND_URL','CORS_ALLOWED_ORIGINS',
'CUSTOMER_SESSION_COOKIE','CUSTOMER_SESSION_TTL','CUSTOMER_SESSION_DOMAIN','CUSTOMER_SESSION_SECURE','CUSTOMER_SESSION_SAME_SITE',
